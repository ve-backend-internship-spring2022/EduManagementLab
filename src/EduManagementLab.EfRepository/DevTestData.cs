...
namespace EduManagementLab.EfRepository
{
    public class DevTestData
    {
        ...
        public static IEnumerable<Course> GetDevTestCourses()
        {
            ...
            {
                new Course() { Id = Guid.Parse("{56E96EA1-90D5-47E9-A1FA-93073614B7FB}"), Code = "ECO1", Name = "Economy 1", Description = "Introduction course to economy", EnrolledDate = DateTime.Now.AddDays(-60), EndDate = DateTime.Now.AddDays(-30), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{1BFE9361-8CEE-42A8-881D-28BAC263B6B9}"), Code = "ECO2", Name = "Economy 2", EnrolledDate = DateTime.Now.AddDays(-29), EndDate = DateTime.Now.AddDays(40), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{A94CC958-3777-4814-BCB7-5DB3F7A25D74}"), Code = "MAN1", Name = "Management 1", Description = "Introduction course to management", EnrolledDate = DateTime.Now.AddDays(-25), EndDate = DateTime.Now.AddDays(30), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{18B9CDAE-BED0-468A-9491-E2394212CA75}"), Code = "MAN2", Name = "Management 2", EnrolledDate = DateTime.Now.AddDays(5), EndDate = DateTime.Now.AddDays(45), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{B2D5A544-5015-4821-8D68-7E3658DCFBA2}"), Code = "ACC1", Name = "Accounting 1", Description = "Introduction course to management", EnrolledDate = DateTime.Now.AddDays(-34), EndDate = DateTime.Now.AddDays(83), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{88C51C50-4571-45AF-9381-B12B9E0845A7}"), Code = "ENT1", Name = "Entrepreneurship 1", Description = "Course to help entrepreneurs grow their business.", EnrolledDate = DateTime.Now.AddDays(-14), EndDate = DateTime.Now.AddDays(22), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{B5C95752-B067-406E-9758-C701DCE58EA9}"), Code = "RED1", Name = "Real Estate Development 1", Description = "EDP-Sales and Marketing Management for Real Estate", EnrolledDate = DateTime.Now.AddDays(-33), EndDate = DateTime.Now.AddDays(11), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{B9F20A7E-7362-4E49-ACC2-58C7F9D517B6}"), Code = "PRM1", Name = "Project Management 1", Description = "This course is the first in a series of six to equip you with the skills you need to apply to introductory-level roles in project management", EnrolledDate = DateTime.Now.AddDays(-5), EndDate = DateTime.Now.AddDays(41), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{BF641F31-9C3C-4690-9928-6A1F58FB49AF}"), Code = "AGT1", Name = "Agile Testing 1", Description = "ISTQB (BCS) Certified Tester Foundation", EnrolledDate = DateTime.Now.AddDays(-29), EndDate = DateTime.Now.AddDays(12), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{C68EA325-9527-4343-934E-67D7998B7B16}"), Code = "TDD1", Name = "Test Driven Development 1", Description = "The fundamentals of Test-Driven Development", EnrolledDate = DateTime.Now.AddDays(-24), EndDate = DateTime.Now.AddDays(31), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{F8C2613F-6133-41F8-A224-6DAA65DBFAC2}"), Code = "SAL1", Name = "Sales 1", Description = "Introduction course to sales", EnrolledDate = DateTime.Now.AddDays(-31), EndDate = DateTime.Now.AddDays(19), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{CE38E160-EC70-4A34-82D3-F42099F67327}"), Code = "SAL2", Name = "Sales 2", EnrolledDate = DateTime.Now.AddDays(19), EndDate = DateTime.Now.AddDays(75), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{DDA58C7C-8105-4377-89AD-AB504E87C89D}"), Code = "EMC1", Name = "Embedded C 1", Description = "Course in the Embedded C language", EnrolledDate = DateTime.Now.AddDays(-19), EndDate = DateTime.Now.AddDays(44), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{B8EEEF95-B579-45D4-8E86-2862C6FEB1C6}"), Code = "QUC1", Name = "Quality Control 1", Description = "Comprehensive course which provides a systematic development of skills and knowledge of QA", EnrolledDate = DateTime.Now.AddDays(-14), EndDate = DateTime.Now.AddDays(31), Memperships = new List<Course.Membership>() {
                ...
                new Course() { Id = Guid.Parse("{7659C805-D968-4910-BDF6-6936FAB38FC3}"), Code = "POL1", Name = "Public Administration 1", Description = "Course specializing in public management and administration.", EnrolledDate = DateTime.Now.AddDays(-27), EndDate = DateTime.Now.AddDays(26), }
            };
